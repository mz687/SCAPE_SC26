...
- llama-1.8B computation
- llama-1.8B communication
...
RESULTS: Dict[str, Dict[str, Dict[str, List[float]]]] = {
    "baseline": {
        "llama-500M": {
            "computation": [7838.642, 3910.932, 1976.316, 1002.929, 494.280],
            "communication": [852.696, 993.093, 1070.979, 1147.580, 1259.380],
        },
        "llama-1.8B": {
            "computation": [11001.024, 5551.220, 2793.638, 1423.607, 815.935],
            "communication": [3025.944, 3559.286, 3789.311, 4024.064, 4171.283],
        },
    },
    "dist-optm": {
        "llama-500M": {
            "computation": [7802.810, 3932.356, 1972.566, 997.888, 516.700],
            "communication": [643.761, 764.637, 836.741, 894.399, 988.854],
        },
        "llama-1.8B": {
            "computation": [11102.710, 5542.143, 2803.886, 1419.204, 751.678],
            "communication": [2270.045, 2735.057, 2902.781, 3005.293, 3138.494],
        },
    },
}
...
def plot_histogram(method: str, output_path: Path, dpi: int) -> None:
    ...
    total_13b = [
        c + m
        for c, m in zip(
            method_results["llama-1.8B"]["computation"],
            method_results["llama-1.8B"]["communication"],
        )
    ]
    ...
    red_offsets = [(0, 10), (0, 10), (0, 10), (0, 10), (0, 10)]
    blue_offsets = [(12, -10), (0, 10), (0, 10), (0, 10), (0, 10)]
    ...
    # Keep constrained_layout only; mixing with tight_layout triggers warnings.
