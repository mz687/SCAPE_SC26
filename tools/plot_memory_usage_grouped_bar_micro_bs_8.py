...
MODEL_VALUES = {
    "llama-500M": [38430.00, 37548.00, 42680.00, 41096.00, 44086.00, 42502.00],
    "llama-1.3B": [49460.00, 40922.00, 54026.00, 49392.00, 60486.00, 55852.00],
    "llama-1.8B": [60024.00, 47980.00, 68290.00, 61930.00, 75832.00, 69474.00],
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("memory_usage_grouped_bar.pdf"),
        help=(
