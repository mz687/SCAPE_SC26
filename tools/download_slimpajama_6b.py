#!/usr/bin/env python3
"""Stream the full SlimPajama-6B dataset to JSONL for SCAPE preprocessing."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Stream SlimPajama from Hugging Face and write one JSON object with a "
...
def main() -> int:
    ...
    print(f"Streaming {args.dataset_name} split={args.split} to {output_path}")
