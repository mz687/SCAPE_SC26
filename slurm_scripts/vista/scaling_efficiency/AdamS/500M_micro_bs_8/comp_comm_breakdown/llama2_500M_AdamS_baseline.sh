...
export HF_HOME=/home1/09308/zhengmk/.cache/huggingface
...
# USER_HOME=/home1/09308/zhengmk
# USER_LOCAL="${USER_HOME}/.local"
# CONTAINER_PY_VER="$($CONTAINER_CMD python3 -c 'import sys; print(f"{sys.version_info.major}.{sys.version_info.minor}")')"
# USER_LOCAL_SITE_PACKAGES="${USER_LOCAL}/lib/python${CONTAINER_PY_VER}/site-packages"
# echo "CONTAINER_PY_VER=${CONTAINER_PY_VER} USER_LOCAL_SITE_PACKAGES=${USER_LOCAL_SITE_PACKAGES}"
...
$CONTAINER_CMD env CC="$CC" CXX="$CXX" CUDAHOSTCXX="$CUDAHOSTCXX" \
  PYTHONPATH="${USER_LOCAL_SITE_PACKAGES}${PYTHONPATH:+:${PYTHONPATH}}" \
